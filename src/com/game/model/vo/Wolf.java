...
public class Wolf extends Character5G {

	private Scanner scan = new Scanner(System.in);

	public Wolf() {
		super("우두머리 늑대", 100, 10000, 0, "초보우두머리 늑대", "우두머리 늑대의 콧물", "", "", "치킨킥", "치킨 펀치");

	}

	public void cry() {

		System.out.println("우두머리 늑대가 위용을 뿜으며 등장합니다");

	}

	public void peck(User user) {
		System.out.println("우두머리 늑대가 할퀴었습니다.");
	...
	public void lossHp(User user) {
		...
		user.passive();
			...
			while (true) {
				...
				switch (select) {
				case 1:
					System.out.println("우두머리 늑대이 비명을 지르며 hp가" + user.attack + "만큼 감소합니다");
				...
				case 3:
					...
					System.out.println("우두머리 늑대이 비명을 지르며 hp가" + user.spskill2dmg + "만큼 감소합니다");
					break;

				case 4:
					super.setHp(super.getHp() - user.spSkill3());
					System.out.println("우두머리 늑대이 비명을 지르며 hp가" + user.spskill3dmg + "만큼 감소합니다");

					break;
				case 5:
					super.setHp(super.getHp() - user.finaleSkill());
					System.out.println("우두머리 늑대이 비명을 지르며 hp가" + user.fskilldmg + "만큼 감소합니다");
				...
				if (super.getHp() <= 0)	{
					System.out.println("우두머리 늑대가 쓰러집니다 ");
					User.coin+=50;
					break;
					
				}
				System.out.println("우두머리 늑대의 남은 체력 :" + hp);
